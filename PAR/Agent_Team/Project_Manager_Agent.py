...
7. Verify the final section document generated by the document generation agent according to the document evaluation criteria in item 6 of the <document_writing_guidlines></document_writing_guidlines> XML tag. If the document evaluation score is not above 4 points, provide detailed feedback and re-request the respective agent.
</restrictions>
